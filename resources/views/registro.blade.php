...
<html lang="en">
    ...
    <body>
        ...
        <form id="registro" action="{{ route('register.store') }}" method="POST" enctype="multipart/form-data">
            @csrf <label class="title" style="margin-bottom: 5px; font-weight: bold;">REGISTRO</label>
            ...
            <input type="text" name="tlfn" placeholder="999 99 99 99" required> 
